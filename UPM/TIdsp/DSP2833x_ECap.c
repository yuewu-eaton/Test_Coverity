...
//   GpioCtrlRegs.GPAMUX2.bit.GPIO26 = 0;    // Configure GPIO26 as GPIO.  Rectifier enable 2
//   GpioCtrlRegs.GPADIR.bit.GPIO26 = 1;  // output pin
...
// Comment out other unwanted lines.
 ...
 //  GpioCtrlRegs.GPAPUD.bit.GPIO11 = 0;   // Enable pull-up on GPIO11 (CAP4)
     GpioCtrlRegs.GPAPUD.bit.GPIO27 = 1;   // Disable pull-up on GPIO27 (CAP4)
...
//   GpioCtrlRegs.GPAPUD.bit.GPIO1 = 0;     // Enable pull-up on GPIO1 (CAP6)
     GpioCtrlRegs.GPBPUD.bit.GPIO49 = 1;    // Disable pull-up on GPIO49 (CAP6)
