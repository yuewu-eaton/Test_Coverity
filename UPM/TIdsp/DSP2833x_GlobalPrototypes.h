...
extern void DMACH1AddrConfigAndStart(volatile Uint16 *DMA_Dest,volatile Uint16 *DMA_Source);
...
extern void StartePWMTimers( void );
extern void StopePWMTimers( void );
#if DSP28_EQEP1
...
Uint16 DSP28x_DisableInt( void );
void   DSP28x_RestoreInt( Uint16 );
